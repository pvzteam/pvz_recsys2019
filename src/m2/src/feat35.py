...
def feat_extract(df):
    df_encode = custom_cate_encoding.cate_label_encoding(df, ['impressions'], 'target')

    df_feat = df[ID_NAMES + ['cv']].merge(df_encode, \
            on=['impressions', 'cv'], how='left')
    del df_feat['cv']
...
if __name__ == "__main__":
    ...
    root_path = '../feature/'
    base_tr_path = root_path + 'tr_s0_27.ftr'
    base_te_path = root_path + 'te_s0_27.ftr'
