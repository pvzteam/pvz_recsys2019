...
def add_meta_fea(df):
    for op in ['median']:
        df['prices_div_active_items-session_id_by_prices_{}-v2'.format(op)] = \
                df['prices'] / df['active_items-session_id_by_prices_{}-v2'.format(op)]
    del_cols = ['active_items-session_id_by_prices_{}-v2'.format(op) \
...
if __name__ == "__main__":
    ...
    root_path = '../feature/'
    base_tr_path = root_path + 'tr_s0_67.ftr'
    base_te_path = root_path + 'te_s0_67.ftr'
